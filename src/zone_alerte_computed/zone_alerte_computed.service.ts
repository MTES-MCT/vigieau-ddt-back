...
export class ZoneAlerteComputedService {
  ...
  async computeGeoJson() {
    let allZones = await this.zoneAlerteComputedRepository
      ...
      .addSelect('zone_alerte_computed.id')
      .addSelect('zone_alerte_computed.nom')
      .addSelect('zone_alerte_computed.code')
      .addSelect('zone_alerte_computed.type')
      .addSelect('zone_alerte_computed."niveauGravite"')
